(window.Modernizr = (function (e, t, n) {
  ...
  function c(e, t, r) {
    for (var a in e) {
      var i = t[e[a]];
      if (i !== n)
        return r === !1 ? e[a] : o(i, "function") ? i.bind(r || t) : i;
    }
    return !1;
  }
  function l(e, t, n) {
  ...
  function s() {
    (d.input = (function (n) {
      ...
      return (
        k.list &&
          (k.list = !(!t.createElement("datalist") || !e.HTMLDataListElement)),
        k
      );
    })(
      ...
      (d.inputtypes = (function (e) {
        for (var r, o, a, i = 0, c = e.length; c > i; i++)
          b.setAttribute("type", (o = e[i])),
            (r = "text" !== b.type),
            r &&
              ((b.value = E),
              (b.style.cssText = "position:absolute;visibility:hidden;"),
              /^range$/.test(o) && b.style.WebkitAppearance !== n
                ? (h.appendChild(b),
                  (a = t.defaultView),
                  (r =
                    a.getComputedStyle &&
                    "textfield" !==
                      a.getComputedStyle(b, null).WebkitAppearance &&
                    0 !== b.offsetHeight),
                  h.removeChild(b))
                : /^(search|tel)$/.test(o) ||
                  (r = /^(url|email)$/.test(o)
  ...
  for (var $ in C)
    p(C, $) &&
      ((u = $.toLowerCase()), (d[u] = C[$]()), P.push((d[u] ? "" : "no-") + u));
  return (
    d.input || s(),
    (d.addTest = function (e, t) {
      if ("object" == typeof e) for (var r in e) p(e, r) && d.addTest(r, e[r]);
      else {
        if (((e = e.toLowerCase()), d[e] !== n)) return d;
        (t = "function" == typeof t ? t() : t),
          m !== n && m && (h.className += " " + (t ? "" : "no-") + e),
          (d[e] = t);
      }
      return d;
    }),
      ...
      function i(e, n, r) {
        ...
        return (
          (o = r.cache[e]
            ...
            : r.createElem(e)),
          o.canHaveChildren && !d.test(e) ? r.frag.appendChild(o) : o
        );
      }
      function c(e, n) {
        ...
        n = n || a(e);
        for (
          var r = n.frag.cloneNode(), i = 0, c = o(), l = c.length;
          l > i;
          i++
        )
          r.createElement(c[i]);
  ...
  (function (e, t, n) {
    ...
    function l(e, n, r, o, a, l, s) {
      ...
      var s = s || f.errorTimeout,
        ...
        d = 0,
        y = 0,
        b = { t: r, s: n, e: a, a: l, x: s };
      1 === j[n] && ((y = 1), (j[n] = [])),
        "object" == e ? (p.data = n) : ((p.src = n), (p.type = e)),
        (p.width = p.height = "0"),
        (p.onerror =
          p.onload =
        ...
        "img" != e &&
          (y || 2 === j[n]
            ? (x.insertBefore(p, E ? null : h), m(u, s))
            : j[n].push(p));
    }
    function s(e, t, n, r, a) {
      return (
        ...
        (t = t || "j"),
        o(e)
          ? l("c" == t ? T : S, e, t, this.i++, n, r, a)
          : (g.splice(this.i++, 0, e), 1 == g.length && c()),
        this
      );
    }
    function u() {
    ...
    (f = function (e) {
      function t(e) {
        ...
        for (n = 0; i > n; n++)
          (r = e[n].split("=")), (t = k[r.shift()]) && (a = t(a, r));
        ...
        l.url.split(".").pop().split("?").shift(),
          l.bypass ||
            (o &&
              (o = r(o)
                ? o
                : o[e] || o[i] || o[e.split("/").pop().split("?")[0]]),
            l.instead
              ? l.instead(e, o, a, i, c)
              : (j[l.url] ? (l.noexec = !0) : (j[l.url] = 1),
                a.load(
                  l.url,
                  l.forceCSS ||
                    (!l.forceJS &&
      ...
      if (o(e)) i(e, 0, p, 0);
        ...
        for (l = 0; e.length > l; l++)
          (s = e[l]),
            o(s) ? i(s, 0, p, 0) : w(s) ? f(s) : Object(s) === s && c(s, p);
  ...
  Modernizr.addTest({
    texttrackapi:
      "function" == typeof document.createElement("video").addTextTrack,
