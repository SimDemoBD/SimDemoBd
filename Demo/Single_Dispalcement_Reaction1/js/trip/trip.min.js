 ...
 */ (function (e, t) {
  ...
  (n.prototype = {
    ...
    showExpose: function (e) {
      this.hasExpose = !0;
      var t, n;
      (t = { position: e.css("position"), zIndex: e.css("z-Index") }),
        (n = { position: "relative", zIndex: this.settings.overlayZindex + 1 }),
    ...
    doLastOperation: function () {
      return (
        ...
        this.hideTripBlock(),
        this.hasExpose && this.hideExpose(),
        this.settings.backToTopWhenEnded &&
    ...
    checkTripData: function (e) {
      if (typeof e.sel == "undefined" || typeof e.content == "undefined")
        return (
          this.console.warn("Your tripData is not valid in obj :" + e + "."), !1
        );
    },
    ...
    init: function () {
      this.preInit(),
        this.settings.enableKeyBinding && this.bindKeyEvents(),
        (this.$bar = t(".trip-progress-bar")),
        (this.$overlay = t(".trip-overlay")),
        (this.$tripArrow = t(".trip-arrow")),
